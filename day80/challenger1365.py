...
1365. Quantos Números São Menores que o Número Atual
Dado o array nums, para cada nums[i], descubra quantos números no array são menores que ele. Ou seja, para cada nums[i], você deve contar o número de j válidos, de forma que j != i e nums[j] < nums[i].
Retorne a resposta em um array.
